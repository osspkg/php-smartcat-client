...
/**
 * LspUpdateServiceModelV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class LspUpdateServiceModelV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LspUpdateServiceModelV2';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'description' => 'string',
        'serviceTypes' => '\SmartCat\Model\LspServiceType[]',
        'specializations' => '\SmartCat\Model\Specialization[]',
        'workUnitType' => '\SmartCat\Model\WorkUnitType'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('workUnitType', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets serviceTypes
     *
     * @return \SmartCat\Model\LspServiceType[]|null
     */
     ...
     * Sets serviceTypes
     *
     * @param \SmartCat\Model\LspServiceType[]|null $serviceTypes Provided service types
     *
     * @return self
     */
    public function setServiceTypes($serviceTypes)
    {
        if (is_null($serviceTypes)) {
            array_push($this->openAPINullablesSetToNull, 'serviceTypes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('serviceTypes', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        return $this->container['workUnitType'];
    }

    /**
     * Sets workUnitType
     *
     * @param \SmartCat\Model\WorkUnitType|null $workUnitType workUnitType
     *
     * @return self
     */
    public function setWorkUnitType($workUnitType)
    {
        if (is_null($workUnitType)) {
            throw new \InvalidArgumentException('non-nullable workUnitType cannot be null');
        }
        $this->container['workUnitType'] = $workUnitType;
