...
/**
 * ImportJobModelV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class ImportJobModelV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportJobModelV2';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payUntilDate', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['payUntilDate'];
    }

    /**
     * Sets payUntilDate
     *
     * @param \DateTime|null $payUntilDate Pay until date (not mandatory)
     *
     * @return self
     */
    public function setPayUntilDate($payUntilDate)
    {
        if (is_null($payUntilDate)) {
            array_push($this->openAPINullablesSetToNull, 'payUntilDate');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payUntilDate', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['payUntilDate'] = $payUntilDate;
