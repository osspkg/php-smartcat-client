...
/**
 * FileInfoModel Class Doc Comment
 *
 * @category Class
 ...
 */
class FileInfoModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FileInfoModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('lastAccessTime', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Original name of the file
     *
     * @return self
     */
     ...
     * Sets mime
     *
     * @param string|null $mime Mime type of the file
     *
     * @return self
     */
     ...
     * Sets path
     *
     * @param string|null $path Path of file in storage
     *
     * @return self
     */
     ...
     * Sets createdAt
     *
     * @param \DateTime|null $createdAt Date when file was uploaded
     *
     * @return self
     */
     ...
     * Sets lastAccessTime
     *
     * @param \DateTime|null $lastAccessTime Date when file was last time accessed
     *
     * @return self
     */
    public function setLastAccessTime($lastAccessTime)
    {
        if (is_null($lastAccessTime)) {
            array_push($this->openAPINullablesSetToNull, 'lastAccessTime');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lastAccessTime', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets expirationTime
     *
     * @param \DateTime|null $expirationTime Date when file will be deleted if not used
     *
     * @return self
     */
