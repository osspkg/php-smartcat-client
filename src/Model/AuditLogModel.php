...
class AuditLogModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('userNickName', $data ?? [], null);
    ...
    */
     ...
     * Sets time
     *
     * @param \DateTime|null $time Event time
     *
     * @return self
     */
     ...
     * Sets userEmail
     *
     * @param string|null $userEmail User E-mail
     *
     * @return self
     */
     ...
     * Sets userNickName
     *
     * @param string|null $userNickName User nickname
     *
     * @return self
     */
    public function setUserNickName($userNickName)
    {
        if (is_null($userNickName)) {
            array_push($this->openAPINullablesSetToNull, 'userNickName');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('userNickName', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets payload
     *
     * @param array<string,mixed>|null $payload Payload data
     *
     * @return self
     */
