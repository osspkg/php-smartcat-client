 ...
 */
class LabelModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LabelModel';
    ...
    */
     ...
     * Sets color
     *
     * @param string|null $color Label color
     *
     * @return self
     */
