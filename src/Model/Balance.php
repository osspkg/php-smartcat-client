...
class Balance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('freeMoney', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['freeMoney'];
    }

    /**
     * Sets freeMoney
     *
     * @param float|null $freeMoney freeMoney
     *
     * @return self
     */
    public function setFreeMoney($freeMoney)
    {
        if (is_null($freeMoney)) {
            throw new \InvalidArgumentException('non-nullable freeMoney cannot be null');
        }
        $this->container['freeMoney'] = $freeMoney;
